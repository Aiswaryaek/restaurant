...
class AccountReceivableDetail extends StatefulWidget {
  const AccountReceivableDetail({super.key});

  @override
  State<AccountReceivableDetail> createState() => _AccountReceivableDetailState();
}

class _AccountReceivableDetailState extends State<AccountReceivableDetail> {
  List<String> date = [
    '23/09/2024',
    '23/09/2024',
    '23/09/2024',
