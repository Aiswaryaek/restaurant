...
import '../detail/account_receivable_detail.dart';

class AccountReceivableList extends StatefulWidget {
  const AccountReceivableList({super.key});

  @override
  State<AccountReceivableList> createState() => _AccountReceivableListState();
}

class _AccountReceivableListState extends State<AccountReceivableList> {
                    ...
                    child:Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          width: AppScreenUtil().screenWidth(370),
