...
class AccountPayableAgingReportDetail extends StatefulWidget {
  const AccountPayableAgingReportDetail({super.key});

  @override
  State<AccountPayableAgingReportDetail> createState() => _AccountPayableAgingReportDetailState();
}

class _AccountPayableAgingReportDetailState extends State<AccountPayableAgingReportDetail> {
  List<String> date = [
    '23/09/2024',
    '23/09/2024',
    '23/09/2024',
