...
class PaymentsCreateScreen extends StatefulWidget {
  String tappedItem;

  PaymentsCreateScreen(this.tappedItem, {super.key});

  @override
  State<PaymentsCreateScreen> createState() => _PaymentsCreateScreenState();
}

class _PaymentsCreateScreenState extends State<PaymentsCreateScreen> {
