...
class SalesWithSo extends StatefulWidget {
  const SalesWithSo({super.key});

  @override
  State<SalesWithSo> createState() => _SalesWithSoState();
}

class _SalesWithSoState extends State<SalesWithSo> {
  final List<String> _dropdownItems = ['01', '02', '03'];
  String? _selectedItem;
  final locationController = TextEditingController();
  final invoiceReferenceController = TextEditingController();
        ...
        currentTab == 'Invoice Lines'
          ...
          children: [
            Align(alignment: Alignment.centerLeft,
              child: SizedBox(width: AppScreenUtil().screenWidth(150),child: CustomTextFieldWithTitle(
                  controller: paymentReferenceController,
