...
class _VendorsState extends State<Vendors> {
  ...
  Widget build(BuildContext context) {
    return Padding(padding: EdgeInsets.fromLTRB(16, 0, 16, 25), child: Column(
                ...
                child: Align(
                  ...
                  child: Column(
                    children: [
                      ...
                      Transform.translate(
                        offset: Offset(-10, 0), child: SvgPicture.asset(
