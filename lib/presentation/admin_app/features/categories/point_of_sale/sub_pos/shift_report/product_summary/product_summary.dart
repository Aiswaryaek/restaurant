...
class ProductSummaryTab extends StatefulWidget {
  const ProductSummaryTab({super.key});

  @override
  State<ProductSummaryTab> createState() => _ProductSummaryTabState();
}

class _ProductSummaryTabState extends State<ProductSummaryTab> {
  ///Payment
  List<String> product = [
    'PROD1',
    'PROD1',
