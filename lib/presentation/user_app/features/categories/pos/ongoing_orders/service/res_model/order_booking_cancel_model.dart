...
//
//     final orderBookingCancelResModel = orderBookingCancelResModelFromJson(jsonString);

import 'dart:convert';

OrderBookingCancelResModel orderBookingCancelResModelFromJson(String str) => OrderBookingCancelResModel.fromJson(json.decode(str));

String orderBookingCancelResModelToJson(OrderBookingCancelResModel data) => json.encode(data.toJson());

class OrderBookingCancelResModel {
    String? id;
    int? transNo;
    String? name;
    String? shiftId;
    ...
    factory OrderBookingCancelResModel.fromJson(Map<String, dynamic> json) => OrderBookingCancelResModel(
        id: json["_id"],
