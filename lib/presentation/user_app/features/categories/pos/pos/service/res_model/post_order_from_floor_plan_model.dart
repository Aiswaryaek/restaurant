...
//
//     final postOrderFromFloorPlanResModel = postOrderFromFloorPlanResModelFromJson(jsonString);

import 'dart:convert';

PostOrderFromFloorPlanResModel postOrderFromFloorPlanResModelFromJson(String str) => PostOrderFromFloorPlanResModel.fromJson(json.decode(str));

String postOrderFromFloorPlanResModelToJson(PostOrderFromFloorPlanResModel data) => json.encode(data.toJson());

class PostOrderFromFloorPlanResModel {
    Data? data;
    KotData? kotData;
    ...
    factory PostOrderFromFloorPlanResModel.fromJson(Map<String, dynamic> json) => PostOrderFromFloorPlanResModel(
