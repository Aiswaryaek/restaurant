...
//
//     final postPosPaymentResModel = postPosPaymentResModelFromJson(jsonString);

import 'dart:convert';

PostPosPaymentResModel postPosPaymentResModelFromJson(String str) => PostPosPaymentResModel.fromJson(json.decode(str));

String postPosPaymentResModelToJson(PostPosPaymentResModel data) => json.encode(data.toJson());

class PostPosPaymentResModel {
    String? id;
    int? transNo;
    String? name;
    String? shiftId;
    ...
    factory PostPosPaymentResModel.fromJson(Map<String, dynamic> json) => PostPosPaymentResModel(
        id: json["_id"],
